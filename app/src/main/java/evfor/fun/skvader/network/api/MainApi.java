...
import evfor.fun.skvader.network.models.response.RsCount;
import evfor.fun.skvader.network.models.response.RsGetComm;
import evfor.fun.skvader.network.models.response.RsGetEvent;
...
import evfor.fun.skvader.network.models.response.RsSoc;
